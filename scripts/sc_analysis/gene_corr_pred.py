...
gs.enr_results['norm_auc'] = gs.enr_results['AUC']/gs.enr_results['Overlap'].str.split('/',expand=True)[0].astype(int)
gs.enr_results.sort_values(by='AUC',inplace=True,ascending=False)
